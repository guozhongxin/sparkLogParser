...
public class SparkLogLabel
{
    ...
    public static String STAGE_INFO = "Stage Info";
    ...
    public static String TASK_END_REASON = "Task End Reason";
    ...
    public static String TASK_EXECUTOR_ID = "Executor ID";

    public static String TASK_METRICS = "Task Metrics";
    public static String TASK_DESERIALIZE_TIME = "Executor Deserialize Time";
    public static String TASK_SERIALIZE_TIME = "Result Serialization Time";
    ...
    public static String TASK_INPUT_METRICS= "Input Metrics";
    ...
    public static String TASK_SHUFFLE_READ_METRICS = "Shuffle Read Metrics";
    public static String TASK_SHUFFLE_REMOTE_BLOCKS = "Remote Blocks Fetched";
    public static String TASK_SHUFFLE_LOCAL_BLOCKS = "Local Blocks Fetched";
    public static String TASK_SHUFFLE_REMOTE_BYTES = "Remote Bytes Read";
    public static String TASK_FETCH_WAIT_TIME = "Fetch Wait Time";
